...
function Activate_History(props) {
  ...
  const Binary_Income = async () => {
    try {
      let responce = await API.get(
        `/getUserActivateHistory?userid=${userid}&fdate=${fromDate}&tdate=${toDate}`
      );
  ...
  var [matching_income, set_matching_income] = new useState({
    cols: [
      ...
      { Header: "Investment", accessor: "on_amount" },
      // {
      //   Header: "Txn",
      //   accessor: "txn",
      //   Cell: ({ cell }) => (
      ...
      { Header: "Date & Time", accessor: "Total_Business" },
    ],
  });
