...
function SingleLeg_Income() {
  ...
  const Single_Inc1ome_Api = async () => {
    try {
      let responce = await API.get(
        `/Get_WithdrawlSingleLeg_Income?uid=${userid}`
      );
  ...
  var [matching_income, set_matching_income] = new useState({
    cols: [
      ...
      { Header: "Single Leg Income", accessor: "netIncome" },
      // { Header: 'Capping Amount', accessor: '' },
...
export default SingleLeg_Income;
